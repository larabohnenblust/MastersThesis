...
ax.axvline(x=0, color='k', linewidth = 0.5)
plt.xlabel("$\ t$")
plt.ylabel("$ A_0$",rotation='horizontal')
ax.yaxis.set_label_coords(-0.04,0.93)
...
ax.axvline(x=0, color='k', linewidth = 0.5)
plt.xlabel("$\ t$")
plt.ylabel("$\\rho_M$",rotation='horizontal')
...
ax.axvline(x=0, color='k', linewidth = 0.5)
plt.xlabel("$\ t$")
plt.ylabel("$\\rho_M + P_M$",rotation='horizontal')
...
ax.axvline(x=0, color='k', linewidth = 0.5)
plt.xlabel("$\ t$")
plt.ylabel("$\ q_S$",rotation='horizontal')
ax.yaxis.set_label_coords(-0.05,1)
...
ax.axvline(x=0, color='k', linewidth = 0.5)
plt.xlabel("$\ t$")
plt.ylabel("$\ F_S$",rotation='horizontal')
...
ax.axvline(x=0, color='k', linewidth = 0.5)
plt.xlabel("$\ t$")
plt.ylabel("$\ c_S$",rotation='horizontal')
ax.yaxis.set_label_coords(0,1.02)
